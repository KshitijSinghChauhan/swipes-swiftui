            ...
            ZStack {
                ForEach(cardViews) { cardView in
                    cardView
                        ...
                        .scaleEffect(self.dragState.isDragging && self.isTopCard(cardView: cardView)
                                     ? 0.85 : 1.0)
                        .rotationEffect(
                            Angle(degrees: self.isTopCard(cardView: cardView) ? self.dragState.translation.width / 12 : 0)
                        )
